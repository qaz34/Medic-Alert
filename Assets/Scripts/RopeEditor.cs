...
[ExecuteInEditMode]
public class RopeEditor : MonoBehaviour
{
    [SerializeField]
    ...
    [SerializeField]
    public float width;
    [SerializeField, Tooltip("1 uv per pulse")]
    public int NumberOfUvs;
    [SerializeField]
    private bool drawLines;
    public LineRenderer lr;
    [SerializeField]
    public List<GameObject> gameobjs = new List<GameObject>(0);
    ...
    public void MakeRope()
    {
        ...
        for (float i = 0; i <= resolution; i++)
        {
            ...
            GameObject go = Instantiate(RopePrefab, GetPoint(progress), new Quaternion(), transform);
            gameobjs.Add(go);
            if (i == 0)
            {
